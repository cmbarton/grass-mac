...
These releases require you to have installed needed ***[frameworks](frameworks/)*** or ***<a href="/frameworks/"> frameworks2</a>*** (AKA dependencies or helper programs) before installing GRASS for the first time. Check the frameworks page to make sure you have the appropriate framework versions.
