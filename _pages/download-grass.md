...
1. You need to download and install some helper programs, called *frameworks* (the same as "dependencies" on Linux systems). I've provided these as compiled packages on the **[frameworks page]({% link /frameworks/ %})

[frameworks page](https://cmbarton.github.io/grass-mac/_pages/download-frameworks.md)
