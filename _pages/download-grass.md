...
{: .notice--warning}
These releases require you to have installed needed <a href="https://cmbarton.github.io/grass-mac/frameworks/"><i><b>frameworks</i></b></a> (AKA dependencies or helper programs) before installing GRASS for the first time. Check the frameworks page to make sure you have the appropriate framework versions.
