...
{: .notice--warning}
These releases require you to have installed needed <i><b><a href="https://cmbarton.github.io/grass-mac/frameworks/">frameworks</a></i></b> (AKA dependencies or helper programs) before installing GRASS for the first time. Check the frameworks page to make sure you have the appropriate framework versions.
